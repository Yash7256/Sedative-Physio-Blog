  ...
  return <div className="resources-page min-h-screen overflow-hidden bg-[#f4f4f2] text-[#111214]">
    <main className="mx-auto max-w-[1280px] px-4 pb-20 sm:px-5 lg:px-[52px]">
      <section data-scroll-fade className="mx-auto grid max-w-[1200px] items-center gap-10 py-8 pl-8 sm:py-10 sm:pl-50 lg:grid-cols-2">
        <div className="relative aspect-square w-full max-w-[480px] overflow-hidden rounded-[18px] bg-[#e9e9e7]"><SmartImage data-parallax src="/bento4.png" alt="Sedative Physio AI assistant" className="h-full w-full object-cover" /><span className="absolute right-2 top-2 rounded-full bg-[#1683f6] px-3 py-1 text-[10px] font-bold tracking-[.08em] text-white">NEW</span></div>
